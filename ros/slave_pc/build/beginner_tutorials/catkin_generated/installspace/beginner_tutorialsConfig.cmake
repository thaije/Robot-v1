...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tjalling/Desktop/Robot/ros/slave_pc/install/${idir}'.  Ask the maintainer 'Tjalling Haije <tjalling_haije@outlook.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tjalling/Desktop/Robot/ros/slave_pc/install/lib;/home/tjalling/Desktop/Robot/ros/master_rpi/devel/lib;/home/tjalling/Desktop/Robot/ros/slave_pc/devel/lib;/opt/ros/indigo/lib)
