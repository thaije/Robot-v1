...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/tjalling/Desktop/Robot/ros/slave_pc/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/tjalling/Desktop/Robot/ros/slave_pc/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/tjalling/Desktop/Robot/ros/slave_pc/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tjalling Haije <tjalling_haije@outlook.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tjalling/Desktop/Robot/ros/slave_pc/src/beginner_tutorials/${idir}'.  Ask the maintainer 'Tjalling Haije <tjalling_haije@outlook.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tjalling/Desktop/Robot/ros/slave_pc/devel/lib;/home/tjalling/Desktop/Robot/ros/master_rpi/devel/lib;/home/tjalling/Desktop/Robot/ros/slave_pc/devel/lib;/opt/ros/indigo/lib)
